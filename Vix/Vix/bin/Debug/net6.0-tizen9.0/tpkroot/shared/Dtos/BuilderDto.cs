...
// --- NUEVAS CLASES PARA EL JSON DE NAVEGACIÓN (DEL MENÚ) ---

public class UiResponse // Root de la respuesta de CONTENIDO de página
{
    public Data data { get; set; }
    public Extensions extensions { get; set; }
}

public class NavigationResponse // Root de la respuesta de NAVEGACIÓN
{
    public NavigationRootData Data { get; set; }
    public Extensions Extensions { get; set; }
}

public class NavigationRootData
{
    public List<UiNavigation> UiNavigation { get; set; }
}

public class UiNavigation
{
    public string Id { get; set; }
    public string MenuType { get; set; } // "CTV_APP_SETTINGS", "CTV_APP_STICKY"
...
{
    public string Id { get; set; }
    public string UrlPath { get; set; } // Esta será tu pageId para LoadPageContent
    public string Text { get; set; }
    public string IconName { get; set; } // HOME, CHANNELS, MOVIES, etc.
    public object Icon { get; set; } // Puede ser null
    public string Action { get; set; }
    public List<NavigationItem> SubItems { get; set; } // Para menús anidados si se implementan
}